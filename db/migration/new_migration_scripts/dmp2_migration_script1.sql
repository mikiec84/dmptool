...
-- # add ldap_info to Users table to migrate Dmptool Ldap username and password into Roadmap 
call AddColumn('roadmap', 'users', 'ldap_password', 'VARCHAR(255)');
call AddColumn('roadmap', 'users', 'ldap_username', 'VARCHAR(255)');
